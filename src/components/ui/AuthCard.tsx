...
export function AuthCard({ type, onSubmitAction }: AuthCardProps) {
  ...
  return (
    <div className="flex items-center justify-center h-screen">
      <div className="max-w-2xl w-full h-full sm:h-auto flex items-center justify-center bg-card sm:p-10 sm:rounded-lg sm:shadow-lg">
        <div className="w-full">
          ...
          <form
            ...
            className="flex flex-col mt-6 w-full px-6 sm:px-0"
          >
            ...
            <input
              ...
              {...form.register("email")}
              className="pl-6 py-3 mb-3 w-full bg-input rounded-lg placeholder-black text-black focus:outline-none focus:ring-2 focus:ring-primary"
            />
            ...
            <div className="flex justify-end mt-6">
              <AuthButton label={buttonText} type="submit" variant="primary" />
            </div>
          </form>
        </div>
      </div>
